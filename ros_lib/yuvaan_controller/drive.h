#ifndef _ROS_yuvaan_controller_drive_h
#define _ROS_yuvaan_controller_drive_h
...
namespace yuvaan_controller
{
  ...
  class drive : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yuvaan_controller/drive"; };
    virtual const char * getMD5() override { return "b1dd02d8c99c39b8457292a0b8bdd1a9"; };
